...
#line 187 "cminus.tab.c" /* yacc.c:358  */
...
{
       0,    48,    48,    51,    62,    65,    67,    70,    83,    83,
     103,   105,   109,   108,   127,   129,   132,   142,   145,   156,
     156,   168,   170,   178,   188,   190,   193,   203,   206,   208,
     210,   212,   214,   218,   220,   223,   228,   235,   241,   245,
     250,   250,   257,   260,   267,   267,   275,   281,   284,   286,
     287,   288,   289,   290,   293,   298,   301,   303,   306,   311,
     314,   316,   319,   321,   323,   325,   328,   330,   330,   338,
     340,   344,   354,   357
};
#endif
...
static const char *const yytname[] =
{
  ...
  "programa", "decl_list", "decl", "var_decl", "@1", "tipo_spec",
  "fun_decl", "@2", "params", "param_lista", "param", "@3", "compost_decl",
  "local_decl", "stmt_lista", "stmt", "exp_decl", "sel_decl", "iter_decl",
  "ret_decl", "exp", "@4", "var", "@5", "simp_exp", "rel", "som_exp",
  "soma", "termo", "mult", "fator", "ativacao", "@6", "args", "arg_lista",
  "vazio", YY_NULLPTR
};
#endif
...
{
     -11,  -100,  -100,     7,   -11,  -100,  -100,    17,  -100,  -100,
    -100,    28,  -100,     0,     6,    31,    14,    12,  -100,    35,
      46,    48,    39,  -100,    59,    42,    53,    15,  -100,    54,
       8,  -100,  -100,    52,  -100,   -11,  -100,  -100,  -100,    83,
      47,  -100,    78,  -100,    -1,  -100,  -100,   100,    86,    95,
      91,  -100,  -100,  -100,  -100,  -100,  -100,  -100,    79,    98,
    -100,    68,    56,  -100,  -100,    80,    97,   101,   100,  -100,
      99,   100,  -100,   103,  -100,  -100,  -100,  -100,  -100,  -100,
    -100,  -100,   100,   100,  -100,  -100,   100,   100,    41,  -100,
     102,  -100,   104,   100,  -100,    74,    56,  -100,    84,  -100,
     105,    92,  -100,    67,    67,  -100,  -100,  -100,   100,   106,
    -100,  -100,    67,  -100
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       3,     8,     7,     0,     0,     0,     0,     0,    21,    11,
       0,     0,    14,    17,     0,    18,     0,     0,     9,     0,
       0,    13,    16,     0,    25,    73,    24,    20,    23,     0,
       0,    27,     8,    66,    43,    65,    34,     0,     0,     0,
       0,    22,    29,    26,    28,    30,    31,    32,     0,    63,
      42,    47,    55,    59,    64,     0,     0,     0,     0,    38,
       0,     0,    33,     0,    56,    57,    48,    50,    49,    51,
      52,    53,     0,     0,    60,    61,     0,     0,     0,    62,
       0,    39,     0,     0,    63,    46,    54,    58,     0,    72,
       0,    69,    70,     0,     0,    41,    45,    68,     0,    35,
      37,    71,     0,    36
};
...
{
    -100,  -100,  -100,   114,    85,  -100,   -13,  -100,  -100,  -100,
    -100,    94,  -100,   107,  -100,  -100,   -99,  -100,  -100,  -100,
    -100,   -47,  -100,   -27,  -100,  -100,  -100,    43,  -100,    40,
    -100,    38,  -100,  -100,  -100,  -100,   -34
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      22,    23,    29,    52,    35,    40,    53,    54,    55,    56,
      57,    58,    73,    59,    65,    60,    82,    61,    83,    62,
      86,    63,    64,    66,   100,   101,    36
};
...
{
      67,    41,    70,    20,   109,   110,     1,     9,     2,    34,
     -67,   -73,   -73,   113,    20,    18,    18,    16,   -73,   -73,
      11,    90,    39,   -73,    92,   -73,   -73,   -73,   -73,   -44,
      15,     1,     1,    19,     2,    17,   -73,   -73,    12,   -12,
      98,    99,    43,    24,    44,    45,   105,   -15,    43,    25,
      44,    45,    47,   -73,   102,    94,    94,    46,    47,    94,
      26,   111,    48,    84,    85,    49,    27,    50,    43,    28,
      44,    45,   -19,    74,    75,    30,    51,    46,    47,    74,
      75,    30,    48,    37,    33,    49,    42,    50,    12,    72,
      76,    77,    78,    79,    80,    30,    43,    68,    44,    45,
      81,    43,    71,    44,    45,    69,    47,   -40,    88,    91,
      87,    47,    93,    89,   103,   106,   104,   107,    10,   108,
      38,    32,   112,    96,    97,    95,     0,     0,     0,     0,
       0,     0,     0,    31
};

static const yytype_int8 yycheck[] =
{
      47,    35,    49,    16,   103,   104,    17,     0,    19,     1,
      11,     3,     4,   112,    27,     1,     1,    11,    10,    11,
       3,    68,    35,    15,    71,    17,    18,    19,    20,    30,
      30,    17,    17,    19,    19,     4,    28,    29,    10,    11,
      87,    88,     1,    31,     3,     4,    93,    12,     1,     3,
       3,     4,    11,    12,    88,    82,    83,    10,    11,    86,
      12,   108,    15,     7,     8,    18,    27,    20,     1,    10,
       3,     4,    30,     5,     6,    28,    29,    10,    11,     5,
       6,    28,    15,    31,    30,    18,     3,    20,    10,    10,
      22,    23,    24,    25,    26,    28,     1,    11,     3,     4,
      32,     1,    11,     3,     4,    10,    11,     9,    11,    10,
      30,    11,     9,    12,    12,    31,    12,    12,     4,    27,
      35,    27,    16,    83,    86,    82,    -1,    -1,    -1,    -1,
      -1,    -1,    -1,    26
};
...
static const yytype_uint8 yystos[] =
{
      ...
      37,     3,    10,    39,    42,    30,    11,     4,     1,    19,
      40,    43,    44,    45,    31,     3,    12,    27,    10,    46,
      28,    47,    45,    30,     1,    48,    70,    31,    38,    40,
      49,    70,     3,     1,     3,     4,    10,    11,    15,    18,
      20,    29,    47,    50,    51,    52,    53,    54,    55,    57,
      59,    61,    63,    65,    66,    58,    67,    55,    11,    10,
      55,    11,    10,    56,     5,     6,    22,    23,    24,    25,
      26,    32,    60,    62,     7,     8,    64,    30,    11,    12,
      55,    10,    55,     9,    57,    61,    63,    65,    55,    55,
      68,    69,    70,    12,    12,    55,    31,    12,    27,    50,
      50,    55,    16,    50
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      45,    45,    47,    48,    48,    48,    49,    49,    50,    50,
      50,    50,    50,    51,    51,    52,    52,    53,    54,    54,
      56,    55,    55,    57,    58,    57,    59,    59,    60,    60,
      60,    60,    60,    60,    61,    61,    62,    62,    63,    63,
      64,    64,    65,    65,    65,    65,    65,    67,    66,    68,
      68,    69,    69,    70
};
...
#line 156 "cminus.y" /* yacc.c:1646  */
    {(yyval).info.str=copyString(tokenString);(yyval).info.scope=copyString(scope);(yyval).info.line=lineno;}
